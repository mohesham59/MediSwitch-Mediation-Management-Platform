            ...
            <nav class="sidebar">
                ...
                <div class="sidebar-section">
                    ...
                    <a href="${pageContext.request.contextPath}/dashboard"
                       class="nav-item <%= currentPath.contains("dashboard") || currentPath.equals("/") ? "active" : ""%>">
                    ...
                    <a href="${pageContext.request.contextPath}/nodes"
                       class="nav-item <%= currentPath.contains("/nodes") ? "active" : ""%>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <circle cx="12" cy="12" r="3"/>
                        <path d="M12 1v4M12 19v4M4.22 4.22l2.83 2.83m9.9 9.9 2.83 2.83M1 12h4m14 0h4M4.22 19.78l2.83-2.83m9.9-9.9 2.83-2.83"/>
                        </svg>
                        Nodes
                    </a>

                    <a href="${pageContext.request.contextPath}/rules"
                       class="nav-item <%= currentPath.contains("/rules") ? "active" : ""%>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="${pageContext.request.contextPath}/blocked"
                       class="nav-item <%= currentPath.contains("/blocked") ? "active" : ""%>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <a href="${pageContext.request.contextPath}/admins"
                       class="nav-item <%= currentPath.contains("/admins") ? "active" : ""%>">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <div class="sidebar-bottom">
                    <div class="admin-badge">
                        <div class="admin-avatar">
                            <%= adminUser != null ? adminUser.substring(0, 1).toUpperCase() : "A"%>
                        </div>
                        <div>
